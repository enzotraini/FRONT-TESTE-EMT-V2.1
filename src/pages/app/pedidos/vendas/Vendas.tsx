...
export function Vendas() {
	const [pedidoSelecionado, setPedidoSelecionado] = useState<PedidoVenda | null>(null);
	...
	const { data: pedidosResponse, isFetching, error } = useQuery({
		queryKey: ["pedidos-venda", page, perPage, search],
		queryFn: async () => {
			// Simular delay da API
			await new Promise(resolve => setTimeout(resolve, 1000));
			
			const mockPedidos: PedidoVenda[] = [
				{
					id: 1,
					numeroPedido: "PV0001",
					tipoVenda: "À Vista",
					...
					cliente: "EMPRESA CLIENTE ABC LTDA",
					dtEntrega: "2025-01-20T00:00:00",
					dtBaixa: "2025-01-18T14:30:00",
					totMercador: 25750.00,
					totalPedido: 30637.50,
					status: "Faturado",
					hora: "10:30",
				...
				},
				{
					...
					totMercador: 18200.00,
					totalPedido: 21476.00,
					status: "Pendente",
					hora: "14:15",
				...
				},
				{
					...
					cliente: "COMÉRCIO 123 LTDA",
					dtEntrega: "2025-01-22T00:00:00",
					totMercador: 12600.00,
					totalPedido: 14868.00,
					status: "Em Produção",
					hora: "09:00",
					vendedor: "Roberto Sales",
					usuario: "ADM",
					loja: "02"
				},
				{
					...
					tipoVenda: "A Prazo",
					tipoPedido: "Especial",
					data: "2025-01-12T16:45:00",
					cliente: "CONSTRUTORA ALFA",
					dtEntrega: "2025-01-25T00:00:00",
					totMercador: 35600.00,
					totalPedido: 42008.00,
					status: "Aprovado",
					hora: "16:45",
					vendedor: "Sandra Vendas",
					usuario: "ADM",
					loja: "01"
				}
			];
	...
	const handlePedidoClick = (pedido: PedidoVenda) => {
	...
	const getStatusColor = (status: string) => {
		switch (status) {
			case 'Faturado': return 'text-green-700 bg-green-50';
			case 'Pendente': return 'text-yellow-700 bg-yellow-50';
			case 'Em Produção': return 'text-blue-700 bg-blue-50';
			case 'Aprovado': return 'text-purple-700 bg-purple-50';
	...
	return (
		<section className="flex flex-col w-full max-h-screen">
			...
			<nav className="p-3 flex gap-3 bg-white border-b border-gray-200 dark:bg-gray-900 dark:border-gray-800">
				...
				<Button variant="ghost" size="sm">Faturados</Button>
							...
							<div className="p-6 border-b border-gray-200">
								<div className="flex items-start justify-between mb-4">
									<div>
										...
										<p className="text-gray-600 mt-1">{pedidoSelecionado.cliente}</p>
									</div>
								...
								<Card>
									...
									<CardContent className="space-y-4">
										<div className="grid grid-cols-1 gap-3">
											...
											<div className="grid grid-cols-2 gap-3">
												<div>
													<label className="text-xs font-medium text-gray-500 uppercase tracking-wide">Tipo Venda</label>
													<p className="text-sm mt-1">{pedidoSelecionado.tipoVenda}</p>
												</div>
												<div>
											...
											{pedidoSelecionado.nota && (
												<div>
													<label className="text-xs font-medium text-gray-500 uppercase tracking-wide">Nota Fiscal</label>
										...
										<div className="space-y-3">
											...
											{pedidoSelecionado.status === 'Aprovado' && (
												<div className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
													...
													<div className="flex-1">
														<p className="font-medium text-sm">Pedido aprovado</p>
														<p className="text-xs text-gray-600 mt-1">Aprovado para produção</p>
														<span className="text-xs text-gray-500">Ontem, 09:15</span>
													</div>
												</div>
											)}
											{pedidoSelecionado.status === 'Em Produção' && (
												<div className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
													...
													<div className="flex-1">
														...
														<p className="text-xs text-gray-600 mt-1">Itens sendo produzidos</p>
